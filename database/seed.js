...
// this is an example. Do not use the variable so it can generate random ten images for each random product.
...
for (var i = 1; i < 3; i ++) {
  var seeding = {
    ...
    images: new Array(10).fill(null).map(e => e = faker.fake("{{image.image}}")),
