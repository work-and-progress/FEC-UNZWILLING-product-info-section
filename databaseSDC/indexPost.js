...
const getProduct = async (pid, cb) => pool.query(`select * from products as a join product_sku as b on a.pid = b.pid where a.pid = ${pid} order by discountpercentage desc limit 1`, cb);
